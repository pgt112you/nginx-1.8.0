...
static ngx_int_t ngx_guangtong_test_init(ngx_conf_t *cf)
{
    printf("jajajajajajajajajajajajajajajajajajajajajajajajajajajajajajajajajajajajajajaja\n");
    //插入到头部处理方法链表的首部
...
//处理响应码200的情形
    ...
    mycf = ngx_http_get_module_loc_conf(r, ngx_guangtong_test_module);
    code_map_stru *node;
...
static void* ngx_guangtong_test_create_conf(ngx_conf_t *cf)
{
    printf("kakakakakakakakakakakakakakakakakakakakakakakakakakakakakakakakakakakakakakaka\n");
    ngx_guangtong_test_conf_t  *mycf;
    
    if (cf->args->nelts >= 2) {
        printf("hello world %d\n", (int)cf->args->nelts);
        ngx_str_t* value = cf->args->elts;
        const char *filename = (const char *)value[2].data;
...
static char* ngx_conf_set_myconfig(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    printf("lalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalalala\n");
